...
const connectionString = ("TURBOPACK compile-time value", "postgresql://neondb_owner:npg_NuZ8XaWnHm5M@ep-rapid-bread-ad2x5b1b-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require");
const pool = new Pool({
    connectionString
});
...
"[project]/app/api/users/sync/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!clerkUser) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("User not found in Clerk", {
                status: 404
            });
        }
        ...
        if (err && typeof err === "object" && "code" in err && err.code === "P2002") {
            console.error("Conflict: Email already exists under a different clerkId.");
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("Email already in use", {
                status: 409
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9a5453f1._.js.map